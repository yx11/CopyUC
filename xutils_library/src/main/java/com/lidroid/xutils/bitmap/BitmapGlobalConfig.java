...
public class BitmapGlobalConfig {
    ...
    public Downloader getDownloader() {
        ...
        downloader.setRequestProperty(getRequestProperty());
        return downloader;
    }
    ...
    public void setRequestProperty(List<NameValuePair> nameValuePairs) {
        this.nameValuePairs = nameValuePairs;
    }

    public List<NameValuePair> getRequestProperty() {
