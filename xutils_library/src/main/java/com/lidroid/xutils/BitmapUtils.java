...
import com.lidroid.xutils.util.ImageUtil;
...
public class BitmapUtils implements TaskHandler {
    ...
    public BitmapUtils configRequestProperty(List<NameValuePair> nameValuePairs) {
        globalConfig.setRequestProperty(nameValuePairs);
        return this;
    }
    ...
    public <T extends View> void displayRoundImg(T container, String uri) {
        display(container, uri, null, new BitmapLoadCallBack<T>() {
            @Override
