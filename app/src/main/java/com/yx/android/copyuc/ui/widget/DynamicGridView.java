...
public class DynamicGridView extends GridView {
    ...
    public void init(Context context) {
        ...
        mOverlapIfSwitchStraightLine = getResources().getDimensionPixelSize(R.dimen.fab_margin);
    }
    ...
    private GridAdapterInterface getAdapterInterface() {
        return ((GridAdapterInterface) getAdapter());
    }
    ...
    private void handleCellSwitch() {
        ...
        for (Long id : idList) {
            ...
            if (view != null) {
                ...
                if ((aboveRight(targetColumnRowPair, mobileColumnRowPair)
                    ...
                    float xDiff = Math.abs(GridViewUtils.getViewX(view) - GridViewUtils.getViewX(mMobileView));
                    float yDiff = Math.abs(GridViewUtils.getViewY(view) - GridViewUtils.getViewY(mMobileView));
        ...
        if (targetView != null) {
            ...
            final GridAdapterInterface adapter = getAdapterInterface();
